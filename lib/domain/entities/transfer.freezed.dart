...
int get hashCode {
  final _this = this as Transfer;
  return Object.hash(runtimeType,_this.id,_this.fromAccountId,_this.toAccountId,_this.amountFrom,_this.amountTo,_this.exchangeRate,_this.transferDate,_this.notes);
}

@override
String toString() {
  final _this = this as Transfer;
  return 'Transfer(id: ${_this.id}, fromAccountId: ${_this.fromAccountId}, toAccountId: ${_this.toAccountId}, amountFrom: ${_this.amountFrom}, amountTo: ${_this.amountTo}, exchangeRate: ${_this.exchangeRate}, transferDate: ${_this.transferDate}, notes: ${_this.notes})';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'from_account_id') String fromAccountId,@JsonKey(name: 'to_account_id') String toAccountId,@JsonKey(name: 'amount_from') num amountFrom,@JsonKey(name: 'amount_to') num amountTo,@JsonKey(name: 'exchange_rate') num exchangeRate,@JsonKey(name: 'transfer_date') DateTime transferDate, String? notes
});
...
/// Create a copy of Transfer
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fromAccountId = null,Object? toAccountId = null,Object? amountFrom = null,Object? amountTo = null,Object? exchangeRate = null,Object? transferDate = null,Object? notes = freezed,}) {
...
switch (_that) {
case _Transfer() when $default != null:
return $default(_that.id,_that.fromAccountId,_that.toAccountId,_that.amountFrom,_that.amountTo,_that.exchangeRate,_that.transferDate,_that.notes);case _:
  return orElse();
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,fromAccountId,toAccountId,amountFrom,amountTo,exchangeRate,transferDate,notes);
}

@override
String toString() {
    return 'Transfer(id: $id, fromAccountId: $fromAccountId, toAccountId: $toAccountId, amountFrom: $amountFrom, amountTo: $amountTo, exchangeRate: $exchangeRate, transferDate: $transferDate, notes: $notes)';
}
...
/// Create a copy of Transfer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fromAccountId = null,Object? toAccountId = null,Object? amountFrom = null,Object? amountTo = null,Object? exchangeRate = null,Object? transferDate = null,Object? notes = freezed,}) {
